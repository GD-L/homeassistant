class BatteryEntity extends Polymer.Element {
  ...
  getBatteryLevel() {
    ...
    if (this.stateObj.attributes.battery)
      batteryValue = this.stateObj.attributes.battery;
    if (this.stateObj.attributes.battery_level)
      batteryValue = this.stateObj.attributes.battery_level;
